...
echo "---" >> $TRG
cat $SRCHTML | sed 's+<body>+<body><ul><li>See the talk <a href="https://youtu.be/gfES21UUEy4">on YouTube</a></li><li><a href="https://arxiv.org/abs/2504.20363">Arxiv link</a></li> <li>Download <a href="dgt_talk_handout.pdf">the slides</a></li></ul><hr/>+' | sed 's+<img src="./a759d588a14f8c3262cd16583e7da6f92659664d.svg" alt="image"+<img src="./a759d588a14f8c3262cd16583e7da6f92659664d.svg" alt="image" id="eq:attach"+' | sed 's+\[eq:attach\]+above+' | egrep -v "(<title>|<h1 class=.title|<p class=.author|<p class=.date)" >> $TRG
