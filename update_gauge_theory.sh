...
echo "---" >> $TRG
cat $SRCHTML | sed 's+<body>+<body><p><b><a href="https://arxiv.org/abs/2504.20363">Arxiv link</a>. <p>Download <a href="discrete_gauge_theory.pdf">the local PDF version</a> or <a href="dgt_talk_handout.pdf">the slides</a></b>.</p>+' | sed 's+<img src="./a759d588a14f8c3262cd16583e7da6f92659664d.svg" alt="image"+<img src="./a759d588a14f8c3262cd16583e7da6f92659664d.svg" alt="image" id="eq:attach"+' | sed 's+\[eq:attach\]+above+' | egrep -v "(<title>|<h1 class=.title|<p class=.author|<p class=.date)" >> $TRG
